...
class Escaper
{
    ...
    /**
     * Construct: Single parameter allows setting of global encoding for use by
     * the current object.
     *
        ...
        if ($encoding !== null) {
            if (! is_string($encoding)) {
                throw new Exception\InvalidArgumentException(
                    get_class($this) . ' Construct parameter must be a string, received ' . gettype($encoding)
                );
            }
            if ($encoding === '') {
                throw new Exception\InvalidArgumentException(
                    get_class($this) . ' Construct parameter does not allow a blank value'
                );
            }
            ...
            if (! in_array($encoding, $this->supportedEncodings)) {
                throw new Exception\InvalidArgumentException(
                    ...
                    . ' Construct parameter is invalid. Provide an encoding supported by htmlspecialchars()'
                );
            }
