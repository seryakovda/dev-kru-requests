...
class VIEW extends \forms\FormView
{
    ...
    {
        $this->TXT_headSmallTitle="Справочник сотрудников";
    ...
    public function greed($data_Object)
    {
        ...
        $greed_Object->GNew(\models\ControlElements::get()->getNameMethod($this->objectFullName,__METHOD__))
            ...
            ->Column("post")   ->Column_Width(1000)->Column_Caption("Должность");
    ...
    public function createEditWorker()
    {
        $HTML = '';
        $width = 700;
        $height = 20;
        ...
        $HTML = $HTML.
            $this->BTN->set("Фамилия инициалы  - <b>".$valProperty."</b>")
                ...
                ->horizontalPosLeft()
                ->marginBottomOff()
                ->func("updatePropertyWorker('$property','$valProperty')")
                ->get();
        ...
        $HTML = $this->WND->set()->nameId('id_editWorker')
            ->headSizeSmall()
